      ...
      <jsp:include page="navbar.jsp"></jsp:include>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Reporter's report card</h1>
          ...
          <div class="row table-responsive" >
              <table class="table">
                  <tr>
                      <td>Name</td><td>No. of News Submitted</td><td>NO. of Approved News</td><td>NO. of Rejected News</td><td>Rating</td>
                    </tr>
                    ...
                    %>
                     <tr>
                        ...
                        <td><%=ndo.getRecordCount(reporter.getId())%></td>
                        <td><%=ndo.getRecordCount(reporter.getId(),"approved")%></td>
                        <td><%=ndo.getRecordCount(reporter.getId(),"rejected")%></td>
                        <%try{
